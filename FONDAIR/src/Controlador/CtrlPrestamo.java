...
public class CtrlPrestamo implements ActionListener {
    ...
    static final Double interesAnual = 0.11;
    static final int interesAnualEntero = 11;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == frmCredito.btnCancelar) {
            ...
            if (frmCredito.txtFolio.getText().isEmpty()) {
                ...
                int  opcion = JOptionPane.showConfirmDialog(null, "¿Seguro que desea cancelar el prestamo? ","Cancelar Prestamo",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
        ...
        if (e.getSource() == frmCredito.btnBuscar) {
            ...
            if (frmCredito.txtFolio.getText().isEmpty()) {
                ...
                if (modC.buscarprestamo(mod)) {
                    ...
                    frmCredito.txtStatus.setText(mod.getStatus());
        ...
        if (e.getSource() == frmCredito.txtNombre) {
            ...
            //***Busca datos de la nomina en la hojai
            /*
