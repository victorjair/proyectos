...
public class Beneficiario {
    ...
    private String porcentajecadena;
    ...
    public String getPorcentajecadena() {
        return porcentajecadena;
    }

    public void setPorcentajecadena(String porcentajecadena) {
        this.porcentajecadena = porcentajecadena;
    }
    ...
    public Beneficiario(String nombre, Double porcentaje, String porcentajecadena, String parentesco, String Id, String fechanacimiento, String rfcAfiliado, int prioridadBeneficiario) {
        this.nombre = nombre;
        this.porcentaje = porcentaje;
        this.porcentajecadena = porcentajecadena;
        this.parentesco = parentesco;
