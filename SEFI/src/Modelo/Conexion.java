...
public class Conexion {
   ...
   /* private final String base = "bachilleresguerrero";
    ...
    private final String base = "bachilleresguerrerosefi";
    ...
    private final String basefiar = "bachilleresguerrerosefi";
    ...
    private final String basenotaremoto = "progr073_programa_sefi";
