...
public class CtrlMenuPrincipal implements ActionListener {
    ...
    private frmPrestamosSindicatos frmPrestamosSindicatos = null;
   
    private frmSindicato frmSindicato = null;
    ...
    private frmCalculoRetiro frmCalculoRetiro = null;
    ...
    public CtrlMenuPrincipal(frmMenuPrincipal MenuPrincipal) {
        ...
        MenuPrincipal.MenuPrestamosSindicatos.addActionListener(this);
        MenuPrincipal.MenuSindicato.addActionListener(this);
        ...
        MenuPrincipal.MenuCalcularRetiro.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == MenuPrincipal.MenuSindicato) {
            if (frmSindicato == null || frmSindicato.isClosed()) {
                frmSindicato = new frmSindicato();
                Sindicato mod = new Sindicato();
                ConsultasSindicato modC = new ConsultasSindicato();
                CtrlSindicato ctrl = new CtrlSindicato(mod, modC,frmSindicato);
                MenuPrincipal.Escritorio.add(frmSindicato);
                frmSindicato.setVisible(true);
        ...
        if (e.getSource() == MenuPrincipal.MenuPrestamosSindicatos) {
            if (frmPrestamosSindicatos == null || frmPrestamosSindicatos.isClosed()) {
                frmPrestamosSindicatos = new frmPrestamosSindicatos();
                Prestamosindicato mod = new Prestamosindicato();
                ConsultasPrestamosSindicato modC = new ConsultasPrestamosSindicato();
                CtrlPrestamoSindicato ctrl = new CtrlPrestamoSindicato(mod, modC,frmPrestamosSindicatos);
                modC.autocompletar(frmPrestamosSindicatos);
                MenuPrincipal.Escritorio.add(frmPrestamosSindicatos);
                frmPrestamosSindicatos.setVisible(true);
        ...
        if (e.getSource() == MenuPrincipal.MenuCalcularRetiro) {
            if (frmCalculoRetiro == null || frmCalculoRetiro.isClosed()) {
                frmCalculoRetiro = new frmCalculoRetiro();
                CalculoRetiro calculoretiro = new CalculoRetiro();
                ConsultasCalculo consultascalculo = new ConsultasCalculo();
                Issste cuotas = new Issste();
                SalarioMinimo minimo = new SalarioMinimo();
                TablaISR isrtabla = new TablaISR();

                ctrlCalculoRetiro ctrl = new ctrlCalculoRetiro(calculoretiro, consultascalculo, frmCalculoRetiro,
                        cuotas, minimo, isrtabla);
                MenuPrincipal.Escritorio.add(frmCalculoRetiro);
                frmCalculoRetiro.setVisible(true);
