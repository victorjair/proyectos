...
public class MovimientosAhorro {
    ...
    public MovimientosAhorro(String Rfc, String Id, String Nombre, String Plantel, Double Abono, Double RetirosAnteriores, Double TotalAhorrado, Double TotalEstado, Double TotalSaldo, Double Ahorros, Double Retiros, Double Saldo, Double Total, String Numeroquincena, String Literal, int Cheque, int Transferencia, String TipoRetiro, String FechaAbono, String UsuarioMovimiento) {
        this.Rfc = Rfc;
        this.Id = Id;
        this.Nombre = Nombre;
        this.Plantel = Plantel;
