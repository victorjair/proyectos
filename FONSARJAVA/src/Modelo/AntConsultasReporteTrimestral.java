 ...
 * @author victor
 */
public class AntConsultasReporteTrimestral extends Conexion {
    ...
    public void imprimereportetrimestral(ReporteTrimestral mov) {
        ...
        String sqlEstadisticas = "SELECT '0' as AFILIADOS,'0' as INCREMENTO,'0' as BAJAS,'0' as FIAS,'0' as APORTACION,\n" +
...
"A.numeroquincena  FROM qnarecuperacionrecuperada A  WHERE A.numeroquincena  >= ?  and A.numeroquincena <=  ?  AND movimiento IN ('D') GROUP BY A.numeroquincena ";
