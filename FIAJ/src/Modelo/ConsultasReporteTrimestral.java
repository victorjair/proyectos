...
public class ConsultasReporteTrimestral extends Conexion {
    ...
    public void imprimereportetrimestral(ReporteTrimestral mov) {
        ...
        Sheet acumulados = book.createSheet("ACUMULADOS");
        Row rowEncabezado = acumulados.createRow(3);
        Row rowAcumuladosMes = acumulados.createRow(5);
        
        Row rowAcumulados = acumulados.createRow(7);
        Row rowAcumulados2 = acumulados.createRow(9);
        Row rowAcumulados3 = acumulados.createRow(11);
        Row rowAcumulados4 = acumulados.createRow(13);
        Row rowAcumulados5 = acumulados.createRow(15);
        Row rowAcumulados6 = acumulados.createRow(17);
        Row rowAcumulados7 = acumulados.createRow(19);
        Row rowAcumulados8 = acumulados.createRow(21);
        Row rowAcumulados9 = acumulados.createRow(23);
        Row rowAcumulados10 = acumulados.createRow(25);
        Row rowAcumulados11 = acumulados.createRow(27);
        Row rowAcumulados12 = acumulados.createRow(29);
        Row rowAcumulados13 = acumulados.createRow(31);
        Row rowAcumulados14 = acumulados.createRow(33);
        Row rowAcumulados15 = acumulados.createRow(35);
        Row rowAcumulados16 = acumulados.createRow(37);
        Row rowAcumulados17 = acumulados.createRow(39);
        Row rowAcumulados18 = acumulados.createRow(41);
        rowEncabezado.createCell(1).setCellValue("FONDO DE INVERSION");
        rowAcumulados.createCell(1).setCellValue("APORTACIONES");
        rowAcumulados2.createCell(1).setCellValue("INTERES GANADO");
        rowAcumulados3.createCell(1).setCellValue("APORTACIONES INVERSION");
        rowAcumulados4.createCell(1).setCellValue("TOTAL APORTACIONES");
        rowAcumulados5.createCell(1).setCellValue("MENOS");
        rowAcumulados6.createCell(1).setCellValue("RETIROS");
        rowAcumulados7.createCell(1).setCellValue("RETIROS INVERSION");
        rowAcumulados8.createCell(1).setCellValue("TOTAL RETIROS");
        rowAcumulados9.createCell(1).setCellValue("PATRIMONIO");
        rowAcumulados10.createCell(1).setCellValue("PRESTAMOS OTORGADOS");
        rowAcumulados11.createCell(1).setCellValue("INTERESES X COBRAR");
        rowAcumulados12.createCell(1).setCellValue("DEVOLUCION X DESCUENTO INDEBIDO");
        rowAcumulados13.createCell(1).setCellValue("TOTAL PRESTAMOS");
        rowAcumulados14.createCell(1).setCellValue("MENOS");
        rowAcumulados15.createCell(1).setCellValue("RECUPERACION DE CREDITOS");
        rowAcumulados16.createCell(1).setCellValue("PAGOS ANTICIPADOS");
        rowAcumulados17.createCell(1).setCellValue("TOTAL RECUPERACIONES");
        rowAcumulados18.createCell(1).setCellValue("ADEUDOS X PRESTAMOS");
       ...
       datosEstiloMoneda.setBorderTop(BorderStyle.THIN);
        ...
        String sqlAcumulados = "SELECT substr(b.numeroquincena,1,4)AS año,ifnull(SUM(b.importe),0) as AportacionesAhorro,\n"
                + "(SELECT ifnull(SUM(a.importe),0) FROM qnaahorrorecuperada a WHERE a.literal = 'ITA'  AND SUBSTR(a.numeroquincena,1,4) = SUBSTR(b.numeroquincena,1,4))AS InteresGanado ,\n"
                + "(SELECT ifnull(SUM(c.importe),0) FROM qnaahorrorecuperada c WHERE c.literal = 'DIV'  AND SUBSTR(c.numeroquincena,1,4) = SUBSTR(b.numeroquincena,1,4)) AS RetirosFiaj, \n"
                + "(SELECT ifnull(SUM(d.monto),0) FROM prestamos d WHERE STATUS NOT IN ('c','C')   AND SUBSTR(d.qna,1,4) = SUBSTR(b.numeroquincena,1,4) )AS PrestamosOtorgados,\n"
                + "(SELECT ifnull(SUM(e.interes),0) FROM prestamos e WHERE STATUS NOT IN ('c','C')   AND SUBSTR(e.qna,1,4) = SUBSTR(b.numeroquincena,1,4) ) AS InteresxCobrar,\n"
                + "(SELECT ifnull(SUM(f.abono),0) FROM qnarecuperacionrecuperada f WHERE f.movimiento = 'I'  AND SUBSTR(f.numeroquincena,1,4) = SUBSTR(b.numeroquincena,1,4))AS Indebidos, \n"
                + "(SELECT ifnull(SUM(g.abono),0) FROM qnarecuperacionrecuperada g WHERE g.movimiento NOT IN  ('I')  AND SUBSTR(g.numeroquincena,1,4) = SUBSTR(b.numeroquincena,1,4)) AS RecuperacionCredito\n"
                + "\n"
                + "\n"
                + "FROM qnaahorrorecuperada  b WHERE  b.literal IN ('CIP') and numeroquincena <= ? GROUP BY SUBSTR(b.numeroquincena,1,4) ";

        ///////////////INICIO ACUMULADO
          try {
            ps = con.prepareStatement(sqlAcumulados);
            if (Integer.parseInt(numeroreporte) == 1) {
                ps.setString(1, periodo + "06");
               

            } else if (Integer.parseInt(numeroreporte) == 2) {
                ps.setString(1, periodo + "12");
                

            } else if (Integer.parseInt(numeroreporte) == 3) {
                ps.setString(1, periodo + "18");
                
            } else if (Integer.parseInt(numeroreporte) == 4) {
                ps.setString(1, periodo + "24");
            ...
            /*Row filaDatosAcumulados = acumulados.createRow(7);
              Row filaDatosAcumulados2 = acumulados.createRow(9);
            ...
            while (rs.next()) {
                ...
                for (int a = 0; a < numCol; a++) {
                    ...
                    Cell CeldaNumeroquincena = rowAcumuladosMes.createCell(numFilaDatosAcumulados);
                    CeldaNumeroquincena.setCellStyle(datosEstilo);
                    CeldaNumeroquincena.setCellValue(rs.getInt("AÑO"));
                    
                    Cell CeldaAportaciones = rowAcumulados.createCell(numFilaDatosAcumulados);
                    CeldaAportaciones.setCellStyle(datosEstiloMoneda);
                    CeldaAportaciones.setCellValue(rs.getDouble("AportacionesAhorro"));
                    
                    Cell CeldaInteresGanado = rowAcumulados2.createCell(numFilaDatosAcumulados);
                    CeldaInteresGanado.setCellStyle(datosEstiloMoneda);
                    CeldaInteresGanado.setCellValue(rs.getDouble("InteresGanado"));
                    
                    Cell CeldaTotalAportaciones = rowAcumulados4.createCell(numFilaDatosAcumulados);
                    CeldaTotalAportaciones.setCellStyle(datosEstiloMoneda);
                    CeldaTotalAportaciones.setCellValue(rs.getDouble("InteresGanado")+ rs.getDouble("AportacionesAhorro"));
                    
                    Cell CeldaRetiros = rowAcumulados6.createCell(numFilaDatosAcumulados);
                    CeldaRetiros.setCellStyle(datosEstiloMoneda);
                    CeldaRetiros.setCellValue(rs.getDouble("RetirosFiaj"));
                    
                    Cell CeldaTotalPatrimonio = rowAcumulados9.createCell(numFilaDatosAcumulados);
                    CeldaTotalPatrimonio.setCellStyle(datosEstiloMoneda);
                    CeldaTotalPatrimonio.setCellValue(rs.getDouble("InteresGanado")+ rs.getDouble("AportacionesAhorro")- rs.getDouble("RetirosFiaj"));
                    
                    Cell CeldaOtorgado = rowAcumulados10.createCell(numFilaDatosAcumulados);
                    CeldaOtorgado.setCellStyle(datosEstiloMoneda);
                    CeldaOtorgado.setCellValue(rs.getDouble("PrestamosOtorgados"));
                    
                    Cell CeldaInteresxCobrar = rowAcumulados11.createCell(numFilaDatosAcumulados);
                    CeldaInteresxCobrar.setCellStyle(datosEstiloMoneda);
                    CeldaInteresxCobrar.setCellValue(rs.getDouble("InteresxCobrar"));
                    
                    Cell CeldaIndebidos = rowAcumulados12.createCell(numFilaDatosAcumulados);
                    CeldaIndebidos.setCellStyle(datosEstiloMoneda);
                    CeldaIndebidos.setCellValue(rs.getDouble("Indebidos"));
                    
                    Cell CeldaTotalPrestamos = rowAcumulados13.createCell(numFilaDatosAcumulados);
                    CeldaTotalPrestamos.setCellStyle(datosEstiloMoneda);
                    CeldaTotalPrestamos.setCellValue(rs.getDouble("PrestamosOtorgados") + rs.getDouble("Indebidos")+rs.getDouble("InteresxCobrar"));
                    
                    Cell CeldaRecuperaciones = rowAcumulados15.createCell(numFilaDatosAcumulados);
                    CeldaRecuperaciones.setCellStyle(datosEstiloMoneda);
                    CeldaRecuperaciones.setCellValue(rs.getDouble("RecuperacionCredito"));
                    
                    Cell CeldaAdeudosXPrestamos = rowAcumulados18.createCell(numFilaDatosAcumulados);
                    CeldaAdeudosXPrestamos.setCellStyle(datosEstiloMoneda);
                    CeldaAdeudosXPrestamos.setCellValue(rs.getDouble("PrestamosOtorgados") + rs.getDouble("Indebidos")+rs.getDouble("InteresxCobrar")-rs.getDouble("RecuperacionCredito"));

                                      

                }
                numFilaDatosAcumulados++;
            ...
            Cell CeldaSumaAportaciones = rowAcumulados.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaAportaciones.setCellStyle(datosEstiloMoneda);
            CeldaSumaAportaciones.setCellFormula("SUM(E8:N8)");
            
            Cell CeldaSumaInteres = rowAcumulados2.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaInteres.setCellStyle(datosEstiloMoneda);
            CeldaSumaInteres.setCellFormula("SUM(E10:N10)");
            
            Cell CeldaSumaTotalAportaciones= rowAcumulados4.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalAportaciones.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalAportaciones.setCellFormula("SUM(E14:N14)");
          
             Cell CeldaSumaTotalRetiros= rowAcumulados6.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalRetiros.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalRetiros.setCellFormula("SUM(E18:N18)");
          
             Cell CeldaSumaTotalPatrimonio= rowAcumulados9.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalPatrimonio.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalPatrimonio.setCellFormula("SUM(E24:N24)"); 
                    
            Cell CeldaSumaTotalOtorgados= rowAcumulados10.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalOtorgados.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalOtorgados.setCellFormula("SUM(E26:N26)");  
            
            Cell CeldaSumaTotalInteresXCobrar= rowAcumulados11.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalInteresXCobrar.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalInteresXCobrar.setCellFormula("SUM(E28:N28)");  
            
            Cell CeldaSumaTotalIndebidos= rowAcumulados12.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalIndebidos.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalIndebidos.setCellFormula("SUM(E30:N30)");  
            
            Cell CeldaSumaTotalPrestamos= rowAcumulados13.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalPrestamos.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalPrestamos.setCellFormula("SUM(E32:N32)");  
            
            Cell CeldaSumaTotalRecuperacion= rowAcumulados15.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalRecuperacion.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalRecuperacion.setCellFormula("SUM(E36:N36)");  
            
            Cell CeldaSumaTotalAdeudos= rowAcumulados18.createCell(numFilaDatosAcumulados + 5);
            CeldaSumaTotalAdeudos.setCellStyle(datosEstiloMoneda);
            CeldaSumaTotalAdeudos.setCellFormula("SUM(E42:N42)");  
