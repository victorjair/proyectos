        ...
        try {
            ...
            while (null != line) {
                ...
                try {
                    ...
                    ps.setString(1, fields[0].substring(0, 4) + "-" + fields[0].substring(4, 10));
                    ps.setString(2, fields[1]);
                    ps.setString(3, fields[2].replace(" ", ""));
                    ps.setString(4, fields[3]);
                    ps.setString(5, fields[4]);
                    ps.setString(6, mov.getNumeroQuincena());
                    ps.setString(7, "CIP");
                    ps.setString(8, fields[5].replace(" ", ""));

                    ps.execute();
                    
                    psremoto = conremoto.prepareStatement(sql);
                    psremoto.setString(1, fields[0].substring(0, 4) + "-" + fields[0].substring(4, 10));
                    psremoto.setString(2, fields[1]);
                    psremoto.setString(3, fields[2].replace(" ", ""));
                    psremoto.setString(4, fields[3]);
                    psremoto.setString(5, fields[4]);
                    psremoto.setString(6, mov.getNumeroQuincena());
                    psremoto.setString(7, "CIP");
                    psremoto.setString(8, fields[5].replace(" ", ""));
