...
public class ConsultasMovimientos extends Conexion {
    ...
    public boolean registrarmovimiento(Movimientos mov) {
        ...
        String sqlactualizastatus = "UPDATE prestamos SET STATUS = CASE WHEN saldo > 0 THEN 'A' "
         ...
         String sqlbuscaId = "select max(Id) from qnarecuperacionrecuperada where folio = ?";
        ...
        try {
            ...
            psremoto.setInt(4, mov.getFolio());
            psremoto.setDouble(5, mov.getAbono());
            psremoto.setInt(6, mov.getNumeroQuincena());
            psremoto.setString(7, mov.getMovimiento());
            //ps.setDouble(8, mov.getSaldo());
            psremoto.setString(8, mov.getFechaAbono());
            psremoto.setString(9, Usuario.usuario);
            psremoto.setDouble(10, mov.getCapital());
            psremoto.setDouble(11, mov.getInteres());
            psremoto.execute();
            ...
            psactualizaremoto.setInt(1, mov.getFolio());
            psactualizaremoto.setInt(2, mov.getFolio());
            psactualizaremoto.setInt(3, mov.getFolio());
            ...
            psactualizasaldoremoto.setInt(1, mov.getFolio());
            psactualizasaldoremoto.execute();
            
            psbuscaId = con.prepareStatement(sqlbuscaId);
            psbuscaId.setInt(1, mov.getFolio());
            psbuscaId.execute();
            
            
            psactualizastatusremoto = conremoto.prepareStatement(sqlactualizastatus);
            psactualizastatusremoto.setInt(1, mov.getFolio());
    ...
    public boolean modificarmovimiento(Movimientos mov){
     ...
     PreparedStatement psactualizastatus = null;
        ...
        try {
            ...
            psactualizastatusremoto = con.prepareStatement(sqlactualizastatus);
            psactualizastatusremoto.setInt(1, mov.getFolio());
            psactualizastatusremoto.execute();
