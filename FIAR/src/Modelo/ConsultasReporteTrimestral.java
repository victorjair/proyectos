        ...
        try {
            ...
            try {
                    ...
                    while (rsRendimientos.next()) {
                        ...
                        PreparedStatement psInsertaRemoto = null;
                        ...
                        psInsertaRemoto = conremoto.prepareStatement(sqlinserta);
                        psInsertaRemoto.setString(1,rsRendimientos.getString("rfc"));
                        psInsertaRemoto.setString(2,rsRendimientos.getString("nombre"));
                        psInsertaRemoto.setString(3,rsRendimientos.getString("plantel"));
                        psInsertaRemoto.setDouble(4,rsRendimientos.getDouble("abono"));
                        psInsertaRemoto.setString(5,periodo+numeroreporte);
                        psInsertaRemoto.setString(6,"ITA");
                        RendimientoComparar = rsRendimientos.getDouble("abono");
                        if(RendimientoComparar > 0)
                        {    
                        psInsertaRemoto.execute();
                        }
                    }
